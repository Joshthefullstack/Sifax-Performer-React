                                          ...
                                          <div className="w-100">
                                            <div className="d-flex justify-content-between align-items-center">
                                              ...
                                              <div className="add-btn">
                                                <div className="progress bg-label-danger" style={{width: "100px"}}>
                                                  <div
                                                    className="progress-bar progress-bar-striped prsogress-bar-animated bg-danger"
                                                    role="progressbar"
                                                    style={{width: "30%"}}
                                                    aria-valuenow={30}
                                                    aria-valuemin={0}
    ...
    <div className="content-wrapper">
      ...
      <div className="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div className="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-6">
                    <div className="user-profile-info">
                      ...
                      <ul className="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4">
                        <li className="list-inline-item text-body">
                          <i className="ri-briefcase-2-line me-2 ri-24px"></i>
                          <span className="fw-medium">Group Head of HR</span>
                        </li>
                        <li className="list-inline-item text-body">
                          <i className="ri-account-circle-line me-2 ri-24px"></i>
                          <span className="fw-medium">Human Resources</span>
                        </li>
                        <li className="list-inline-item text-body">
                          <i className="ri-building-line me-2 ri-24px"></i>
                          <span className="fw-medium">Head Office</span>
                        </li>
                      </ul>
                    </div>
                    <div className="dropdown">
                      ...
                      <div className="dropdown-menu">
                        <a
                          ...
                          <i className="ri-edit-2-line me-1"></i> Edit Staff
                        </a>
                        <a
                          className="dropdown-item"
                          href=""
                          ...
                          <i className="ri-account-circle-line me-1"></i> Make
                          Supervisor
                        </a>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="nav-align-top">
              <ul className="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                <li className="nav-item">
                  <a className="nav-link active" href="/staff-detail">
                    <i className="ri-menu-search-line me-2"></i>Details
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/staff-task">
                    <i className="ri-list-check-3 me-2"></i>Tasks
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/staff-competency">
                    <i className="ri-lightbulb-flash-line me-2"></i>Competencies
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="row">
            ...
            <div className="card mb-6">
              <div className="card-body">
                <div className="plan-statistics mb-4 border-bottom pb-4">
                  ...
                  <div className="progress bg-label-primary mb-1 rounded">
                    <div
                      className="progress-bar progress-bar-animated progress-bar-striped bg-primary rounded"
                      style={{ width: "74%" }}
                      role="progressbar"
                      aria-valuenow={20}
                      aria-valuemin={0}
            ...
            <div className="card">
              <div className="card-header d-flex align-items-center justify-content-between border-bottom">
                <div className="card-title mb-0">
                  <h5 className="m-0 me-2">
                    <i className="ri-folder-open-line ri-24px text-body me-4"></i>
                    Staff Details
                  </h5>
                </div>
              </div>
              <div className="card-body pt-0">
                <div className="info-container">
                  ...
                  <ul className="list-unstyled my-3 py-1">
                    <li className="d-flex align-items-center mb-4">
                      <i className="ri-calendar-schedule-line ri-24px"></i>
                      <span className="fw-medium mx-2">Employment Date:</span>
                      <span>August 10, 2021</span>
                    </li>
                    <li className="d-flex align-items-center mb-4">
                      <i className="ri-account-circle-line ri-24px"></i>
                      <span className="fw-medium mx-2">Manager:</span>
                      <span>Muhmmed Bala</span>
                    </li>
                    <li className="d-flex align-items-center mb-4">
                  ...
                  <ul className="list-unstyled my-3 py-1">
                    <li className="d-flex align-items-center mb-4">
                      ...
                      <span className="fw-medium mx-2">Date of Birth:</span>
                      <span>March 20, 1980</span>
                    </li>
                    <li className="d-flex align-items-center mb-4">
                      <i className="ri-genderless-line ri-24px"></i>
                  ...
                  <ul className="list-unstyled my-3 py-1">
                    ...
                    <li className="d-flex align-items-center mb-2">
                      ...
                      <span className="fw-medium mx-2">Location:</span>
                      <span>Lagos, Nigeria</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="col-xl-8 col-lg-7 col-md-7">
            <h4 className="card-action-title mb-0">
              <i className="ri-focus-2-line ri-24px text-body me-4"></i>KPI
              Overview
            </h4>
            <div className="row mb-4">
              <div className="col-12">
