                    ...
                    <div className="col-md-12">
                        <div className="nav-align-top">
                            <ul className="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="staff-task.html"><i className="ri-list-check-3 me-2"></i>Tasks</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link active" href="staff-competency.html"><i className="ri-lightbulb-flash-line me-2"></i>Competencies</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-8 col-lg-7 col-md-7">
                        <h4 className="card-action-title mb-0">
                            <i className="ri-lightbulb-flash-line ri-24px text-body me-4"></i>Competency Overview</h4>
                        <div className="row mb-4">
                            <div className="col-12">
                                <div className="card card-action mb-3 bordered">
                                    <div className="card-header header-elements border-bottom">
                                        <h6 className="card-action-title mb-0">Core Competencies</h6>

                                        <div className="card-header-elements ms-auto me-3">
                                            <span className="me-4">5 Competencies</span>
                                        </div>
                                            ...
                                            <div className="list-group list-group-flush">
                                                    ...
                                                    <div className="w-100">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="user-info">
                                                                <h6 className="mb-1 fw-normal">Innovative Power
                                                                    <span className="badge bg-success">Expert</span>
                                                                </h6>
                                                                <small>The ability to direct one’s inquisitive mind toward initiating new strategies, products, services, and markets.</small>
                                                                <div className="d-flex align-items-center">
                                                                    <small className="me-2"><strong>Weight: </strong>20%</small>
                                                ...
                                                <div className="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                                    <div className="w-100">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="user-info">
                                                                <h6 className="mb-1 fw-normal">Accountability
                                                                    <span className="badge bg-warning">Emerging</span>
                                                                </h6>
                                                                <small>The ability to direct one’s inquisitive mind toward initiating new strategies, products, services, and markets.</small>
                                                                <div className="d-flex align-items-center">
                                                                    <small className="me-2"><strong>Weight: </strong>20%</small>
                                                ...
                                                <div className="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                                    <div className="w-100">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="user-info">
                                                                <h6 className="mb-1 fw-normal">Innovative Power
                                                                    <span className="badge bg-info">Proficient</span>
                                                                </h6>
                                                                <small>The ability to direct one’s inquisitive mind toward initiating new strategies, products, services, and markets.</small>
                                                                <div className="d-flex align-items-center">
                                                                    <small className="me-2"><strong>Weight: </strong>20%</small>
                                ...
                                <div className="card card-action mb-3 bordered">
                                    <div className="card-header header-elements border-bottom">
                                        <h6 className="card-action-title mb-0">Functional Competencies</h6>
                                        <div className="card-header-elements ms-auto me-3">
                                            <span className="me-4">5 Competencies</span>
                                        </div>
                                        <div className="card-action-element">
                                            ...
                                            <div className="list-group list-group-flush">
                                                <div className="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                                    <div className="w-100">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="user-info">
                                                                <h6 className="mb-1 fw-normal">Accountability
                                                                    <span className="badge bg-danger">Developing</span>
                                                                </h6>
                                                                <small>The ability to direct one’s inquisitive mind toward initiating new strategies, products, services, and markets.</small>
                                                                <div className="d-flex align-items-center">
                                                                    <small className="me-2"><strong>Weight: </strong>20%</small>
                                                ...
                                                <div className="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                                    <div className="w-100">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="user-info">
                                                                <h6 className="mb-1 fw-normal">Integrity
                                                                    <span className="badge bg-primary">Advanced</span>
                                                                </h6>
                                                                <small>Adherence to the standards, values and rules of conduct associated with one’s position and the culture in which one operates. Being incorruptible.</small>
                                                                <div className="d-flex align-items-center">
                                                                    <small className="me-2"><strong>Weight: </strong>20%</small>
                                                                    <div className="user-status d-flex align-items-center">
                                                                        <span className="badge badge-dot bg-success me-1"></span>
                                ...
                                <div className="card card-action mb-3 bordered">
                                    <div className="card-header header-elements border-bottom">
                                        <h6 className="card-action-title mb-0">Leadership Competencies</h6>
                                        <div className="card-header-elements ms-auto me-3">
                                            <span className="me-4">5 Competencies</span>
                                        </div>
                                        <div className="card-action-element">
                                ...
                                <div className="card card-action mb-3 bordered">
                                    <div className="card-header header-elements border-bottom">
                                        <h6 className="card-action-title mb-0">Culture Competencies</h6>
                                        <div className="card-header-elements ms-auto me-3">
                                            <span className="me-4">5 Competencies</span>
                                        </div>
                                        <div className="card-action-element">
...
export default StaffCompetencyContent