...
import ProfForm from "../assets/img/icons/misc/professional-form.png"
import OpForm from "../assets/img/icons/misc/operational-form.png"
import BlankForm from "../assets/img/icons/misc/plus-lg.png"
                            ...
                            <div className="d-flex row">
                                <div className="col-md-12">
                                    <div className="card-body">
                                        ...
                                        <p className="text-truncate mb-4">Select any of these template to get started on form creation</p>
                                        <div className="row">
                                            <div className="col-md-3">
                                                <div className="card text-center align-items-center shadow-none border-primary bg-primary-subtle mx-3">
                                                    <div className="card-body align-items-center">
                                                        <a href="professional-form.html" className="nav-link align-items-center justify-content-center">
                                                            <img src={ProfForm} alt="professional-form" />
                                                            <p className="icon-name text-capitalize fw-medium mb-0 mt-2">Professional Form</p>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className="card text-center align-items-center shadow-none border bg-success-subtle mx-3">
                                                    <div className="card-body align-items-center">
                                                        <a href="operational-form.html" className="nav-link align-items-center justify-content-center">
                                                            <img src={OpForm} alt="operational-form" />
                                                            <p className="icon-name text-capitalize fw-medium mb-0 mt-2">Operational Form</p>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className="card text-center align-items-center shadow-none border bg-warning-subtle mx-3">
                                                    <div className="card-body align-items-center">
                                                        <a href="blank-form.html" className="nav-link align-items-center justify-content-center">
                                                            <img src={BlankForm} alt="blank-form" />
                                                            <p className="icon-name text-capitalize fw-medium mb-0 mt-2">Blank Form</p>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div className="table-responsive text-nowrap">
                        <table className="table border-bottom">
                            ...
                            <tbody className="table-border-bottom-0">
                                <tr>
                                    <td>234</td>
                                    <td>Professional Form</td>
                                    <td>Professional Test Form</td>
                                    <td>
                                    ...
                                    <td>May 10, 2024</td>
                                    <td><div className="badge bg-label-primary">Professional Form</div></td>
                                    <td>
                                ...
                                <tr>
                                    <td>234</td>
                                    <td>Operational Form</td>
                                    <td>Operational Test Form</td>
                                    <td>
                                        <div className="d-flex justify-content-start align-items-center user-name">
                                            <div className="avatar-wrapper">
                                                <div className="avatar avatar-sm me-3">
                                    ...
                                    <td>May 10, 2024</td>
                                    <td><div className="badge bg-label-success">Operational Form</div></td>
                                    <td>
                                        <div className="dropdown">
                                            <button type="button" className="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                <i className="ri-more-2-line"></i>
                                ...
                                <tr>
                                    ...
                                    <td>May 10, 2024</td>
                                    <td><div className="badge bg-label-warning">Blank Form</div></td>
                                    <td>
                                        <div className="dropdown">
                                            <button type="button" className="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                <i className="ri-more-2-line"></i>
