...
import RoleImg from "../assets/img/illustrations/designation.png"
                          ...
                          <div className="d-flex row">
                            <div className="col-md-6 order-2 order-md-1">
                              <div className="card-body">
                                <h4 className="card-title mb-4">Manage <span className="fw-bold">Designations</span> 🎉</h4>
                                <p className="mb-0">Manage all Employee Designations on this page.</p>
                                <p>Add, Edit, View, Delete Designations here.</p>
                                <div className="add-new">
                                    ...
                                    <i className="ri-add-line me-0 me-sm-1 d-inline-block d-sm-none"></i><span className="d-none d-sm-inline-block">  New Designation </span>
                                  </button>
                                  <div
                                    ...
                                    <div className="offcanvas-header">
                                      <h5 id="offcanvasBothLabel" className="offcanvas-title">Create New Designation</h5>
                                      <button
                                        type="button"
                                    ...
                                    <div className="offcanvas-body my-auto mx-0 flex-grow-1">
                                      <form className="add-new-user pt-0" id="addNewUserForm" onSubmit={()=>{}}>
                                        <div className="form-floating form-floating-outline mb-5">
                                          <input
                                            ...
                                            aria-label="" />
                                          <label htmlFor="add-designation-name">Designation Name</label>
                                        </div>
                                        <div className="form-floating form-floating-outline mb-5">
                                          <textarea className="form-control h-px-100" id="add-designation-description" placeholder="Add description here..."></textarea>
                                          <label htmlFor="add-designation-description">Description</label>
                                        </div>
                                        <div className="mb-5">
                                          <input
                                            id="TypeaheadBasic"
                                      ...
                                      <div className="mb-5">
                                        <input
                                          ...
                                          autoComplete="off"
                                          placeholder="Enter states from USA" />
                                          <label htmlFor="TypeaheadBasic" className="form-label">Type to Select Department</label>
                                        </div>
                                        <button type="submit" className="btn btn-primary me-sm-3 me-1 data-submit">Add Designation</button>
                                      </form>              
                                    </div>
                                  </div>
                                </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-10">
                          <div className="d-flex justify-content-md-end">
                            <div className="me-4">
                                <label><input type="search" className="form-control form-control-sm" placeholder="Search Designations"/></label>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="table-responsive text-nowrap">
                        <table className="table border-bottom">
                            ...
                            <tr>
                                ...
                                <td className="text-wrap">coordinates accounts and claims of the company</td>
                                <td>Finance</td>
                                <td>SAHCO Plc</td>
                                <td>
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu">
                                      <a className="dropdown-item" href="designation-detail.html"><i className="ri-eye-line me-1"></i> View Details</a>
                                      ...
                                      <a className="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#createApp"
                                        ><i className="ri-edit-2-line me-1"></i> Add KPI</a>
                            ...
                            <tr>
                                ...
                                <td className="text-wrap">Network maintenance and management</td>
                            ...
                            <tr>
                                <td>236</td>
                                <td>HR Support Executive</td>
                                <td className="text-wrap">Support of Head, HR/Admin in providing administrative, maintenance and some clerical services for the company.</td>
                            ...
                            <tr>
                                <td>237</td>
                                <td>HR Manager</td>
                                <td>Responsible for providing HR Operations</td>
                                <td>Human Resources</td>
                                <td>Head Office</td>
                                <td>
                                <div className="dropdown">
