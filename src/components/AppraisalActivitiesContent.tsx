...
const AppraisalActivitiesContent = () => {
    return (
        <div className="content-wrapper">
            {/* <!-- Content --> */}

            <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="mb-1">Appraisal Activities</h4>
                <p className="mb-6">
                    Create and manage all appraisal activities here.
                </p>
                <div className="card">
                                ...
                                <div className="d-flex justify-content-md-end">
                                    ...
                                    <div className="add-new">
                                        <button
                                            ...
                                            <i className="ri-add-line me-0 me-sm-1 d-inline-block d-sm-none"></i><span className="d-none d-sm-inline-block"> New Activity </span>
                                        </button>
                                        <div
                                            ...
                                            <div className="offcanvas-header">
                                                <h5 id="offcanvasBothLabel" className="offcanvas-title">Create New Appraisal Activity</h5>
                                                <button
                                                    type="button"
                                            ...
                                            <div className="offcanvas-body mx-0 flex-grow-0">
                                                <form className="add-new-user pt-0" id="addNewUserForm" onSubmit={() => { }}>
                                                    <div className="form-floating form-floating-outline mb-5">
                                                        ...
                                                        <label htmlFor="add-rating-name">Activity Name</label>
                                                    </div>
                                                    <div className="form-floating form-floating-outline mb-5">
                                                        ...
                                                        <label htmlFor="add-rating-description">Appraisal Cycle</label>
                                                    </div>
                                                    <div className="mb-5">
                                                    ...
                                                    <div className="form-floating form-floating-outline mb-5">
                                                        ...
                                                        <label htmlFor="TagifyCustomInlineSuggestion" className="form-label">Grade Level</label>
                                                    </div>
                                                    <div className="form-floating form-floating-outline mb-5">
                                                        <select id="select2Multiple" className="select2 form-select" multiple>
                                                        ...
                                                        <label htmlFor="select2Multiple" className="form-label">Appraisal Forms</label>
                                                        <small>Select form templates for this appraisal exercise.</small>
                                                    </div>
                                                    <div className="form-floating form-floating-outline mb-5">
                                                        <input
                                                            type="text"
                                                            ...
                                                            id="flatpickr-range" />
                                                        <label htmlFor="flatpickr-range">Activity Duration</label>
                                                    </div>
                        ...
                        <table className="table border-bottom">
                            ...
                            <tbody className="table-border-bottom-0">
                                <tr>
                                    ...
                                    <td><span>Q3 2023 Performance Appraisal</span></td>
                                    <td><span>Year 2023</span></td>
                                    <td><span className="badge rounded-pill bg-label-dark">2023 Appraisal form</span></td>
                                    <td><span>01/09/2023 - 30/09/2023</span></td>
                                ...
                                <tr>
                                    <td className="dt-checkboxes-cell"><input type="checkbox" className="dt-checkboxes form-check-input" /></td>
                                    <td><span>Q4 2023 Performance Appraisal</span></td>
                                    <td><span>Year 2023</span></td>
                                    <td><span className="badge rounded-pill bg-label-dark">2023 Appraisal form</span></td>
                                    <td><span>01/12/2023 - 31/12/2023</span></td>
                                    <td><span className="badge rounded-pill bg-label-danger me-1">Closed</span></td>
                                    <td>
                                        <div className="dropdown">
                                            <button type="button" className="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                ...
                                <tr>
                                    <td className="dt-checkboxes-cell"><input type="checkbox" className="dt-checkboxes form-check-input" /></td>
                                    <td><span>1st Half 2024 Performance Appraisal</span></td>
                                    <td><span>Year 2024</span></td>
                                    <td><span className="badge rounded-pill bg-label-dark">2024 Appraisal form</span></td>
                                    <td><span>01/07/2024 - 30/07/2024</span></td>
                                ...
                                <tr>
                                    <td className="dt-checkboxes-cell"><input type="checkbox" className="dt-checkboxes form-check-input" /></td>
                                    <td><span>2nd Half 2024 Performance Appraisal</span></td>
                                    <td><span>Year 2024</span></td>
                                    <td><span className="badge rounded-pill bg-label-dark">2024 Appraisal form</span></td>
                                    <td><span>01/12/2024 - 30/12/2024</span></td>
                                    <td><span className="badge rounded-pill bg-label-success me-1">Open</span></td>
                                    <td>
                                        <div className="dropdown">
                                            <button type="button" className="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                ...
                                <tr>
                                    <td className="dt-checkboxes-cell"><input type="checkbox" className="dt-checkboxes form-check-input" /></td>
                                    <td><span>Q1 2025 Performance Appraisal</span></td>
                                    <td><span>Year 2025</span></td>
                                    <td><span className="badge rounded-pill bg-label-dark">2025 Appraisal form</span></td>
                                    <td><span>01/03/2025 - 30/03/2025</span></td>
                                            ...
                                            <div id="submit" className="content text-center pt-4 pt-lg-0">
                                                ...
                                                <div className="col-12 d-flex justify-content-between mt-4 pt-2">
                                                    ...
                                                    <button className="btn btn-primary btn-submit">
                                                        <span className="align-middle d-none d-sm-block me-2">Submit</span><i className="ri-check-line"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
...
export default AppraisalActivitiesContent