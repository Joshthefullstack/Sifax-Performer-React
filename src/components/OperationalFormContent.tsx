...
const OperationalFormContent = () => {
    return (
        <div className="content-wrapper">
            {/* <!-- Content --> */}
            <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="mb-1">Operational Form Template</h4>
                <p className="mb-6">
                    Create a new Operational Form on this page.
                </p>
                <div className="row">
                    {/* <!-- Form Repeater --> */}
                    <div className="col-12">
                        <div className="bs-stepper wizard-numbered mt-2">
                            <div className="bs-stepper-header">
                                ...
                                <div className="step" data-target="#key-results">
                                    <button type="button" className="step-trigger">
                                        <span className="bs-stepper-circle"><i className="ri-check-line"></i></span>
                                        <span className="bs-stepper-label">
                                            <span className="bs-stepper-number">02</span>
                                            <span className="d-flex flex-column gap-1 ms-2">
                                                <span className="bs-stepper-title">Key Result Areas</span>
                                                <span className="bs-stepper-subtitle">Setup KRAs</span>
                                            </span>
                                        </span>
                                    </button>
                                </div>
                                <div className="line"></div>
                                <div className="step" data-target="#core-values">
                                    <button type="button" className="step-trigger">
                                        <span className="bs-stepper-circle"><i className="ri-check-line"></i></span>
                                        <span className="bs-stepper-label">
                                            <span className="bs-stepper-number">03</span>
                                            <span className="d-flex flex-column gap-1 ms-2">
                                                <span className="bs-stepper-title">Core Values</span>
                                                <span className="bs-stepper-subtitle">Setup Core Values</span>
                                            </span>
                                        </span>
                                    </button>
                                </div>
                                <div className="line"></div>
                                <div className="step" data-target="#form-comments">
                                    <button type="button" className="step-trigger">
                                        <span className="bs-stepper-circle"><i className="ri-check-line"></i></span>
                                        <span className="bs-stepper-label">
                                            ...
                                            <span className="d-flex flex-column gap-1 ms-2">
                                                ...
                                                <span className="bs-stepper-subtitle">Add comment Titles</span>
                                            </span>
                                        </span>
                                    </button>
                                </div>
                            ...
                            <div className="bs-stepper-content">
                                <form onSubmit={() => { }}>
                                    ...
                                    {/* <!-- Key Result Areas --> */}
                                    <div id="key-results" className="content">
                                        <div className="content-header mb-4">
                                            <h6 className="mb-0">Key Result Area Questions</h6>
                                            <small>Setup Key Result Area Questions</small>
                                        </div>
                                        <div className="row g-5">
                                            <div className="col-12">
                                                {/* <!-- Questions Container --> */}
                                                <div id="kraQuestions"></div>

                                                <button id="addKRAQuestion" className="btn btn-primary">+ Add Question</button>
                                                <button id="previewForm" className="btn btn-success">Preview Form</button>

                                                {/* <!-- Global Total --> */}
                                                <div className="alert alert-info mt-3">
                                                    Overall Total Score: <span id="overallTotal">0</span> / 100
                                                </div>
                                    ...
                                    {/* <!-- Core Values --> */}
                                    <div id="core-values" className="content">
                                        <div className="content-header mb-4">
                                            <h6 className="mb-0">Core Value Questions</h6>
                                            <small>Setup Core Value Questions</small>
                                        </div>
                                        <div className="row g-5">
                                            <div className="col-12">
                                                {/* <!-- Questions Container --> */}
                                                <div id="cvQuestions"></div>

                                                <button id="addCVQuestion" className="btn btn-primary">+ Add Core Value</button>
                                                <button id="previewForm" className="btn btn-success">Preview Form</button>
                                                ...
                                                {/* <!-- Preview Modal --> */}
                                                <div className="modal fade" id="coreValueModal" tabIndex={-1}>
                                                    <div className="modal-dialog modal-lg">
                                                        <div className="modal-content">
                                                            <div className="modal-header">
                                                                <h5 className="modal-title">Form Preview</h5>
...
export default OperationalFormContent